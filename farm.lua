while true do
wait(15)
game:GetService("Workspace").biokiller60.HumanoidRootPart.CFrame = game:GetService("Workspace").Bosses.Waiting.Titan.qw.CFrame
wait(8)
...
if game:GetService("Workspace").RespawnMobs.Muscle.Muscle then
	game:GetService("Workspace").biokiller60.HumanoidRootPart.CFrame = game:GetService("Workspace").RespawnMobs.Muscle.Muscle.CFrame
end
task.wait(1)
end
